                                                            ...
                                                            <div class="item">
                                                                <div class="py-3">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p class="font-size-14 mb-0">- TeknoKode User</p>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="w-100">
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Skote. Crafted with <i class="mdi mdi-heart text-danger"></i> by TeknoKode</p>
                                    </div>
                                </div>
